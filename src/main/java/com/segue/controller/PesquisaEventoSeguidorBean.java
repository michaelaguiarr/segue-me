...
public class PesquisaEventoSeguidorBean implements Serializable {
	...
	/**
	 * Gera o PDF de crachá apenas dos registros selecionados (por id), sem alterar
	 * a flag de crachá. Reusa o relatório Jasper passando o parâmetro whereCracha
	 * com o filtro de ids (imprime exatamente os marcados, mesmo já impressos).
	 */
