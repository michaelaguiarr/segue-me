...
@Named
@ViewScoped
public class RelatorioCrachaSeguidor implements Serializable {
	...
	public RelatorioCrachaSeguidor() {
		limpar();
	}
	...
	public void emitir() {
		try {
			...
			ExecutorRelatorioDownload executor = new ExecutorRelatorioDownload("/jasper/"+this.nomeArquivo+"Seguidor.jasper",
	 ...
	 * selecionado. Deve ser acionado somente após confirmar que a impressão física
	 * saiu corretamente, para não perder registros quando a impressão falha.
	 */
