...
import com.segue.model.Enum.GrupoIdade;
...
@Named
@ViewScoped
public class RelatorioInscritosPorIdade implements Serializable {
	...
	public RelatorioInscritosPorIdade() {
		limpar();
	}
	...
	public void emitir() {
		try {
			if (this.grupo.equals(GrupoIdade.GRUPO1)) {
				Map<String, Object> parametros = new HashMap<>();
				parametros.put(JRParameter.REPORT_LOCALE, new Locale("pt", "BR"));
				parametros.put("status", this.status);
				parametros.put("segueMe", this.segueMe.getId());
				ExecutorRelatorio executor = new ExecutorRelatorio("/jasper/relacaoInscritosFaixa1619.jasper",
						this.response, parametros, "RelacaoIdade" + grupo + ".pdf");
	...
	public GrupoIdade getGrupo() {
		return grupo;
	}

	public void setGrupo(GrupoIdade grupo) {
		this.grupo = grupo;
	}
