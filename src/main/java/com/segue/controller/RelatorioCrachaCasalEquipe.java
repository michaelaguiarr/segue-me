...
@Named
@ViewScoped
public class RelatorioCrachaCasalEquipe implements Serializable {
	...
	public RelatorioCrachaCasalEquipe() {
		limpar();
	}
	 ...
	 * Segue-Me e da equipe selecionados. Deve ser acionado somente após confirmar
