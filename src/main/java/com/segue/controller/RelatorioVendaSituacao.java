...
@Named
@ViewScoped
public class RelatorioVendaSituacao implements Serializable {
	...
	public void emitir() {
		try {
			fotoService.materializarImagensSegueMe(this.segueMe);   // padroeira/fundo do retiro
			Map<String, Object> parametros = new HashMap<>();
			parametros.put(JRParameter.REPORT_LOCALE, new Locale("pt", "BR"));
			parametros.put("segueMe", this.segueMe.getId());
			parametros.put("praQuem", this.paraQuemVenda);
			parametros.put("status", this.statusVenda);
			ExecutorRelatorioDownload executor = new ExecutorRelatorioDownload("/jasper/miniMercadoStatus.jasper",
					this.response, parametros, "RESUMO" + this.statusVenda + ".pdf");
	...
	public ParaQuemVenda[] getParaQuemVendas() {
