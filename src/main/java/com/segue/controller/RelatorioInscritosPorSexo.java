...
@Named
@ViewScoped
public class RelatorioInscritosPorSexo implements Serializable {
	...
	public RelatorioInscritosPorSexo() {
		limpar();
	}
	...
	public void emitir() {
		try {
			...
			ExecutorRelatorio executor = new ExecutorRelatorio("/jasper/relacaoInscritosSexo.jasper", this.response,
					parametros, "RelacaoInscristoPorSexo" + status + ".pdf");
