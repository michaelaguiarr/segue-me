...
@Named
@ViewScoped
public class RelatorioVendaResumo implements Serializable {
	...
	public void emitir() {
		try {
			...
			ExecutorRelatorioDownload executor = new ExecutorRelatorioDownload("/jasper/miniMercadoTotal.jasper",
					this.response, parametros, "RESUMOGeral.pdf");
