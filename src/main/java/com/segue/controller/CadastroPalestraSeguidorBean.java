...
import com.segue.service.CadastroPalestraSeguidorService;
...
@Named
@ViewScoped
public class CadastroPalestraSeguidorBean implements Serializable {

	private static final long serialVersionUID = 1L;

	@Inject
	private CadastroPalestraSeguidorService service;
	...
	public CadastroPalestraSeguidorBean() {
		limpar();
	}
	...
	public void excluir() {
		try {
			...
			FacesUtil
					.addInfoMessage("Palestrante " + this.evento.getSeguidor().getApelido() + " excluído com sucesso.");
			limpar();
		} catch (NegocioException ne) {
			FacesUtil.addErrorMessage(ne.getMessage());
		}
