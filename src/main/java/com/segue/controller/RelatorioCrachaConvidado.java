...
@Named
@ViewScoped
public class RelatorioCrachaConvidado implements Serializable {
	...
	public RelatorioCrachaConvidado() {
		limpar();
	}
	...
	public void emitir() {
		try {
			...
			ExecutorRelatorioDownload executor = new ExecutorRelatorioDownload("/jasper/"+this.nomeArquivo+"Convidado.jasper",
