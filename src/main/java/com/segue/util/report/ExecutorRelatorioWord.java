...
public class ExecutorRelatorioWord implements Work {
	...
	public ExecutorRelatorioWord(String caminhoRelatorio, HttpServletResponse response, Map<String, Object> parametros,
