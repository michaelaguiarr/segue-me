...
public class ExecutorRelatorioDownload implements Work {
	...
	public ExecutorRelatorioDownload(String caminhoRelatorio, HttpServletResponse response, Map<String, Object> parametros,
	...
	public void execute(Connection connection) throws SQLException {
		try {
			...
			throw new SQLException("Erro ao executar relatório " + e.getMessage(), e);
		}
	}
